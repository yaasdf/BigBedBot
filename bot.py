...
meal = set([
    "盖浇饭", "砂锅", "大排档", "米线", "满汉全席", "西餐", "麻辣烫", "自助餐", "炒面", "快餐", "水果",
    "西北风", "馄饨", "火锅", "烧烤", "泡面", "水饺", "日料", "涮羊肉", "味千拉面", "面包", "扬州炒饭",
    "自助餐", "茶餐厅", "海底捞", "披萨", "金拱门", "KFC", "汉堡王", "卡乐星", "兰州拉面", "沙县小吃",
    "烤鱼", "烤肉", "海鲜", "铁板烧", "韩国料理", "粥", "快餐", "萨莉亚", "桂林米粉", "东南亚菜", "甜点",
    "农家菜", "川菜", "粤菜", "湘菜", "生活", "全家", "黄焖鸡米饭", "群主"
])
